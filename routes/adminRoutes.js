...
const { getMyPersonalDetails, getAllUsers, getPersonalDetails, createPersonalDetails, updatePersonalDetails, deletePersonalDetails, getAllEmp } = require('../controllers/employeeController');
